        ...
        <b-container>
            <b-jumbotron  align='left' bg-variant="light" class='mt-3 mx-auto'  header="About" lead="">
                <p>Horizons library is quick and easily acessible information regarding everything Animal Crossing 
                    New Horizons. You can currently view multiple categories by clicking the 'Explore' button.
                ...
                <p>ACHNI can be visited <a href='http://acnhapi.com/doc' target="_blank">here</a></p>
            </b-jumbotron>  
        </b-container>
    </div>
</template>
